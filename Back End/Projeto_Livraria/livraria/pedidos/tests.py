...
class TestPedidoView(APITestCase):
    def setUp(self):
        ...
        self.dados = {
            ...
            "livros": [{"livro": self.livro.id, "quantidade": 2}],  # type: ignore
        }
    ...
    def test_create_cupom_expirado(self):
        cupom = baker.make(
            Cupom, nome="app10", quantidade_maxima=10, quantidade_utilizada=10
        )  # noqa: E501
    ...
    def test_create_atualiza_quantidade_cupom(self):
        cupom = baker.make(
            Cupom, nome="app10", quantidade_maxima=10, quantidade_utilizada=5
        )
        self.dados["cupom"] = cupom.nome
        resposta = self._post_request(self.dados)
        self.assertEqual(resposta.status_code, HTTP_201_CREATED)
    ...
    def test_update_atualiza_quantidade_cupom(self):
        ...
        cupom_novo = baker.make(
            Cupom, nome="app20", quantidade_maxima=10, quantidade_utilizada=5
        )
