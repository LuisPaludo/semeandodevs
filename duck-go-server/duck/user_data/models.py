...
class CustomUser(AbstractUser):
    ...
    profile_photo = models.ImageField(upload_to='users_photos', null=True, blank=True, validators=[validate_image_size])    
    data_nascimento = models.DateField(null=True, blank=True)
    accepted_terms = models.BooleanField(default=False)


class History(models.Model):
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, primary_key=True, related_name='user_history')
